...
DrawableTile::DrawableTile(Renderer &renderer, bool black_, TileSpriteRepository & repository) :
           renderer(renderer),
           sprite_(&repository.getTile(TileSpriteRepository::TILE_DEFAULT, black_)),
           repository(repository), black(black_) {}

DrawableTile::DrawableTile(DrawableTile &&other) noexcept: renderer(other.renderer),
