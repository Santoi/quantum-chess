...
DrawableChessman::DrawableChessman(Renderer &renderer, ChessmanSpriteRepository &repository,
...
DrawableChessman::DrawableChessman(DrawableChessman &&other) noexcept: renderer(other.renderer),
                                                                       sprite_(other.sprite_),
                                                                       fill(other.fill),
                                                                       probability(other.probability) {}

DrawableChessman &DrawableChessman::operator=(DrawableChessman &&other) noexcept {
